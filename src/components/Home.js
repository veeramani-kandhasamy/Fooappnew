...
const Home = ({ cart, setcart }) => {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src= {require("../assets/briyani1.jpg")} class="d-block w-100" alt="..."/>
    ...
    <div class="carousel-item">
      <img src={require("../assets/img1.jpg")} class="d-block w-100" alt="..."/>
    ...
    <div class="carousel-item">
      <img src={ require("../assets/img4.jpg")} class="d-block w-100" alt="..."/>
      <div class="carousel-caption  d-md-block animated fadeInDown" >
      ...
      {products.map((product) => (
        <div key={product.id} className="col-lg-3 col-md-4 col-sm-6 col-6">
          <div className={`card mb-3 m-3 ${product.id === scrolledProductId? 'crolled-card' : ''}`}>
            ...
            <img src={require("../assets/logo.png")} className="logo-image" alt="Logo Image" style={{
              width: 80,
              height: 80,
              position: 'absolute',
              top: -20,
